        ...
        <div class="w-[20%] h-full bg-[#fff0] flex-col">
            ...
            <div class="w-full h-1/3 flex-col items-center mt-0">
                <div class="w-full h-full flex flex-wrap mt-20 justify-center items-center">
                    <div
                        class="w-[80%]   bg-[#3c3f43] text-white  h-12 rounded-lg flex  items-center justify-center hover:scale-105  transition-all duration-200">
                        <span class="text-lg font-bold text-white">Catatan</span></div>
                    <div
                        ...
                        <span class="text-lg font-bold text-white">To-do List</span></div>
                    <div
                        class="w-[80%] bg-[#3c3f43] h-12 rounded-lg flex  items-center justify-center hover:scale-105 hover:bg-[#2b2d30] transition-all duration-200">
                        <span class="text-lg font-bold text-white">Laporan Keuangan</span></div>
                    <div
                        ...
                        <span class="text-lg font-bold text-white">Forum</span></div>
                </div>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-2 w-full h-auto items-start gap-5 p-5">
                        ...
                        <div
                            ...
                            <div class="h-[55%]">
                                <p class="truncate-overflow text-base">
                                    ...
                                    consectetur adipisicing elit. Debitis sequi beatae dolore sunt deleniti iusto
                                    reiciendis non. Illum velit explicabo reiciendis in. Veniam nobis debitis neque ad
                                    enim fuga dolore? Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Voluptatibus placeat veritatis, voluptatem vel accusantium aliquam, dolorum nobis
                                    veniam voluptatum velit voluptas laborum aut repellat obcaecati labore eum quod
                                    earum maxime? </p>
                        ...
                        <div id="readmorePopup"
                            ...
                            <div
                                ...
                                <div class="flex justify-between h-20 mb-3">
                                    ...
                                    <div class="row">
                                        <span class="close text-white hover:text-gray-300 text-4xl cursor-pointer"
                                            onclick="closeReadmorePopup()">&times;</span>
                                ...
                                <div class="h-auto">
                                    <p class="text-base">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugiat a ut sint.
                                        Repellendus delectus, neque sit tempora, deserunt eaque quaerat adipisci odit
                                        reprehenderit ducimus totam distinctio, ipsam cumque aut tenetur? ipsum dolor
                                        sit amet, consectetur adipisicing elit. Quidem voluptates, ex optio suscipit sed
                                        soluta blanditiis iste porro dignissimos voluptatem tempore, in quod illo rerum.
                                        Nisi quia impedit distinctio voluptatem! ipsum dolor sit amet, consectetur
                                        adipiscing elit. Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                                        Debitis sequi beatae dolore sunt deleniti iusto reiciendis non. Illum velit
                                        explicabo reiciendis in. Veniam nobis debitis neque ad enim fuga dolore? Lorem
                                        ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus placeat
                                        veritatis, voluptatem vel accusantium aliquam, dolorum nobis veniam voluptatum
                                        velit voluptas laborum aut repellat obcaecati labore eum quod earum maxime?
                                    </p>
                                </div>
