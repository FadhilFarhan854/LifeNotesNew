...
<div id="popupEdit" class="fixed inset-0 items-center justify-center hidden bg-gray-800 bg-opacity-50 w-full h-full pt-48">
    <div class="w-[30%] h-[65%] bg-[#1F2124] rounded-lg row p-8 pt-1 shadow-md shadow-[#000000] m-auto flex flex-col justify-start">
        {{-- X-button --}}
        ...
        <div class="w-full h-[85%] mt-4 flex-col">
            <div class="h-[80%]">
                <form action="" class="">                  
                    ...
                    <input type="text" class="bg-white/0 text-white text-base outline-none w-full border-b-2 border-white mt-6 pb-1" value="{{-- kasih value disini dari db --}}" placeholder="Nominal">
                </form> 
